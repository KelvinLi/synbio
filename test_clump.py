...
test_clump.add_sequence(sequence.LinearSequence(make_nucleotide(n) for n in "agctg"))
test_clump.add_sequence(sequence.CircularSequence(make_nucleotide(n) for n in "gctca"))
